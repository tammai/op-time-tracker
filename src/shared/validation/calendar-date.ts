 ...
 * renderer applies it to the date field so a bad day is caught inline, and the
 * main process re-applies it in `CreateTimeEntryInputSchema` before building a
 * request — renderer input is never trusted
