 ...
 * can surface the message to the renderer without try/catch noise.
 */
 ...
 * UI-side and main-process validation share one source of truth.
 */
 ...
 * for surfacing to the renderer. Kept here so the onboarding form and the
